angular.module(_SERVICES_).service('exportService', function ($q,
    ...
    function uploadGalleryPhotos(galleryId) {
        var
            deferred = $q.defer(),
    ...
    function uploadGallery(galleryId) {
        var
            deferred = $q.defer(),
            galleryData = appDataService.getGallery(galleryId);
        ...
        serverAPI.createGallery(galleryData)
            .then(function (apiResult) {
                ...
                return appDataService.getActiveGalleryId();
            })
